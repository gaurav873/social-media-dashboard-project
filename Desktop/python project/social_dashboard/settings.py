...
SECRET_KEY = 'django-insecure-ln%q5t%s_e$#p!e3b^uc((c(uqalw78l%cvb06w0$9eozy#5p0'
...
AUTHENTICATION_BACKENDS = (
    'social_core.backends.facebook.FacebookOAuth2',  # Example
    'social_core.backends.twitter.TwitterOAuth',     # Example
